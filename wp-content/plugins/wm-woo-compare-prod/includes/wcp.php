...
class Wcp {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/wcp-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/wcp-public.php';
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('wp_ajax_add_to_compare', $plugin_public, 'set_to_compare_controller');
		$this->loader->add_action('wp_ajax_nopriv_add_to_compare', $plugin_public, 'set_to_compare_controller');

		$this->loader->add_action('wp_ajax_remove_from_compare', $plugin_public, 'rm_from_compare_controller');
		$this->loader->add_action('wp_ajax_nopriv_remove_from_compare', $plugin_public, 'rm_from_compare_controller');
